...
export default function CustomVsCms() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-12 sm:pt-24 sm:pb-16">
      ...
      >
        <div className="flex-1 space-y-4 md:space-y-5 text-center lg:text-left">
          ...
          <ul className="space-y-4">
            <li className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-3">
              <svg className="w-5 h-5 md:w-6 md:h-6 text-violet-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <span className="text-slate-400 text-xs md:text-sm leading-relaxed"><strong>Actualizaciones que rompen todo:</strong> Actualizas un plugin y tu sistema se cae. El mantenimiento constante es un dolor de cabeza.</span>
            </li>
            <li className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-3">
              <svg className="w-5 h-5 md:w-6 md:h-6 text-violet-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <span className="text-slate-400 text-xs md:text-sm leading-relaxed"><strong>Lentitud extrema:</strong> Las plantillas cargan miles de líneas de código que tu empresa jamás usará.</span>
            </li>
          </ul>
        </div>
        <div className="lg:w-1/3 w-full bg-slate-900/40 border border-slate-800 rounded-2xl p-6 lg:p-8 relative overflow-hidden flex flex-col items-center justify-center text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-3">
            <svg className="w-6 h-6 text-violet-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01M20.618 5.984A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
