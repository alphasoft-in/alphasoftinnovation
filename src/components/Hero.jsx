    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 md:mb-8">
          ...
          <motion.p variants={itemVariants} className="mt-4 max-w-2xl text-base md:text-xl text-slate-400 mx-auto mb-8 md:mb-10">
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full px-4 sm:px-0">
            <motion.a 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              href="/servicios" 
              className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 bg-white text-slate-950 font-semibold rounded-full hover:bg-slate-200 transition-colors duration-200 shadow-[0_0_20px_rgba(255,255,255,0.3)] cursor-pointer text-sm md:text-base"
            >
              Nuestros Servicios
            </motion.a>
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              href="/contacto" 
              className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 bg-transparent border border-slate-700 text-white font-medium rounded-full transition-colors duration-200 cursor-pointer text-sm md:text-base"
            >
